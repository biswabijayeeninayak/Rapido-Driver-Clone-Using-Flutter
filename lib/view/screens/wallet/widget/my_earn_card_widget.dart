                ...
                child: Row(children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      color: walletController.selectedFilterTypeName == 'pending'?
                          Theme.of(context).colorScheme.primaryContainer.withOpacity(.15):
                      walletController.selectedFilterTypeName == 'cancelled'?
                    ...
                    child: Text(PriceConverter.convertPrice(context, myEarnModel.amount!),
                      style: textBold.copyWith(color: walletController.selectedFilterTypeName == 'pending'?
