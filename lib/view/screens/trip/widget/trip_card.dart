...
// @override
// void initState(){
//   fetchRiderBookingWithBookingDetails();
// }
          ...
          Padding(
            ...
            child: Row(children: [
              ...
              Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start,children: [
                Text(widget.tripModel.title!,style: textMedium,),
                Text(DateConverter.isoStringToDateTimeString(widget.tripModel.createdAt!),
                  style: textRegular.copyWith(color: Theme.of(context).hintColor.withOpacity(.85), fontSize: Dimensions.fontSizeSmall),),
                Text('${'total'.tr} ${PriceConverter.convertPrice(context, widget.tripModel.amount!)}',),
              ],)),
