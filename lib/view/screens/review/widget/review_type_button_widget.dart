...
class ReviewTypeButtonWidget extends StatelessWidget {
  ...
  const ReviewTypeButtonWidget({Key? key, required this.index, required this.reviewType}) : super(key: key);
            ...
            child: InkWell(
              ...
              child: Container(width: MediaQuery.of(context).size.width/2.5,
                ...
                decoration: BoxDecoration(
                  ...
                  color: index == reviewController.reviewTypeIndex? Theme.of(context).colorScheme.primary : Theme.of(context).cardColor,
