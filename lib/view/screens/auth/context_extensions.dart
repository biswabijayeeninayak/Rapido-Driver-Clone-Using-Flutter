...
extension ContextExtensions on BuildContext {
  ...
  bool get isAndroid => ContextExtensions(this).platform == TargetPlatform.android;

  bool get isIOS => ContextExtensions(this).platform == TargetPlatform.iOS;

  bool get isMacOS => ContextExtensions(this).platform == TargetPlatform.macOS;

  bool get isWindows => ContextExtensions(this).platform == TargetPlatform.windows;

  bool get isFuchsia => ContextExtensions(this).platform == TargetPlatform.fuchsia;

  bool get isLinux => ContextExtensions(this).platform == TargetPlatform.linux;
