...
class VehicleDocumentsState extends State<VehicleDocuments> {
                              ...
                              DropdownButtonFormField<String>(
                                ...
                                onChanged: (String? value) {
                                  if (value != null) {
                                    ...
                                    print(
                                        "Selected vehicle: ${vehicletypeController.text}");
                                  }
                                },
          ...
          children: [
            Padding(
              ...
              child: commonButton("Cancel", () {
                ...
                Get.to(() => DocumentsDashboard(
                    argument1: getBoolAsync("argument1"),
                    argument2: getBoolAsync("argument2"),
                    argument3: getBoolAsync("argument3"),
                    argument4: getBoolAsync("argument4")));
              ...
              child: commonButton("Proceed", () {
                ...
                if (_formKey.currentState!.validate()) {
                  ...
                  if (vehicletypeController.text.isNotEmpty) {
                    saveVehicleDetails(selectedVehicleType, vehicleno,
                        vehicle_model_year, modelName);
                  } else {
  ...
  Future<void> saveVehicleDetails(String selectedVehicleType, String vehicleno,
      String vehicle_model_year, String modelName) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    String userId = prefs.getString('userId').toString();
    try {
      var url = Uri.parse(
          'http://kods.tech/munsride/api/storeVehicleDetails/$userId');
      ...
      if (response.statusCode == 200) {
        ...
        print(
            'Vehicle details upload failed with status code: ${response.statusCode}');
