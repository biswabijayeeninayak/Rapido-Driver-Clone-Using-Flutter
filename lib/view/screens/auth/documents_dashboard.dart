...
class DocumentsDashboard extends StatefulWidget {
  ...
  const DocumentsDashboard(
      ...
      required this.argument3,
      required this.argument4});
                            ...
                            : AppButton(
                                ...
                                onTap: () {
                                  ...
                                  if (argument1) {
                                    ...
                                    toast(
                                        "Complete create Account process to Submit Documents");
                                  }
                                },
                                // width: context.width(),
                                color: Colors.orange[600],
                            ...
                            : AppButton(
                                ...
                                onTap: () {
                                  ...
                                  if (argument2 && argument1) {
                                    ...
                                    toast(
                                        "Complete Submit document section to proceed with Document Verification ");
                                  }
                                },
                                // width: context.width(),
                                color: Colors.orange[600],
