...
//             children: [
//             Text(notificationModel.data.status, style: textSemiBold.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeLarge),),
//             Padding(
...
//             ),
//             Text(DateConverter.isoStringToDateTimeString(notificationModel.message),
                  ...
                  children: [
                    ...
                    Text(
                      DateConverter.isoStringToDateTimeString(
                          notificationData.createdAt.toIso8601String()),
                      style: textRegular.copyWith(
                          color: Theme.of(context)
                              .hintColor
                              .withOpacity(.85),
